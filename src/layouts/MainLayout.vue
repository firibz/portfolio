    ...
    <q-page-container>
      <q-page class="flex flex-center">
        <div class="row full-width justify-center">
          <div
            class="column full-height col-xs-12 col-sm-9 col-md-12 col-xl-10"
          >
            <div class="row full-width justify-center container">
              ...
              >
                <div
                  :class="
                    $q.screen.lt.md
                      ? 'full-width row justify-center items-center card custom-rounded-borders-bottom q-pb-sm q-px-xs'
                      : 'column items-center card menu-borders'
                  "
                  style="display: flex"
                >
                  <q-btn-toggle
              ...
              <div
                :class="
                  $q.screen.lt.md
                    ? 'order-first custom-rounded-borders-top'
                    : 'card custom-rounded-borders'
                "
              ...
              >
                ...
                <span class="text-caption text-system-primary q-mt-sm"
                  >+{{ experienceYears }} {{ t("experienceYears") }}</span
                >
                ...
                <div class="text-center q-mt-sm">
                  ...
                  >
                    <q-tooltip
                      v-if="socialItem.hover"
                      class="bg-system-primary text-section text-body2 ltr"
                      :offset="[10, 10]"
                    >
                      {{ socialItem.hover }}
                    </q-tooltip>
                ...
                <q-btn
                  ...
                  href="fariborz_korevli_frontend_09_2025.pdf"
                  download
                />
                <hr
                  v-if="$q.screen.lt.md"
                  class="q-mb-md full-width section-hr"
                />
              </div>
              <div
                class="column col-xs-11 col-md-6 full-height page-section relative-position overflow-hidden q-py-md"
              >
                <div
                  id="top-of-page"
                  :class="
                    $q.screen.lt.md
                      ? 'custom-rounded-borders q-pa-lg'
                      : 'card custom-rounded-borders-right q-px-xl q-py-lg'
                  "
